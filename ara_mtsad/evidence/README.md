...
| Affiliation-family conversion | `tables/affiliation_family_check.md`, `tables/affiliation_timesnet_*.json` | `scripts/mtsad/score_affiliation.py` on persisted scores versus CATCH Table 2 |
