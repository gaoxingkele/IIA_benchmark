...
| iTransformer (ICLR 2024) | available in the local PDF and in CATCH Table 2 | both families in different papers | not re-run | inverted-attention reconstruction harness |
