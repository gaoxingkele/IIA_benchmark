...
| `fcc_alarm` | ReSeeD 官方 4 个附件已下载并校验；alarm/process adapter、G0、完整 run split 与首批 9 个实验已完成 | 1,600 个仿真 run、16 类异常、每类 100 run；每个 run 有 60 个一分钟采样、57 个报警位，并配套过程/阀位/扰动序列；T3/T4/open-set/鲁棒性 | [ReSeeD](https://reseed.ruhr-uni-bochum.de/concern/datasets/19217e41-e9ad-4c0e-bb51-97e7072813f7)，FCC DOI `10.60517/2v23vv393`，CC BY 4.0；误命名候选包实际 DOI `10.60517/19027803-fec9-41f2-8a02-408cc176554e` |
