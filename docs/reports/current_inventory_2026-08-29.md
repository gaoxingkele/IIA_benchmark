...
| `book_3_1_convex_noz` | 3.1.2 | Convex-hull normal operating zone alarm | 印刷页 131-137 / PDF 142-148 | `iia_benchmark.models.multivariate.ConvexHullNOZAlarm` | `partial` |
...
| `book_3_4_condenser` | 3.4 | Physics-guided condenser normal operating zones | 印刷页 192-217 / PDF 203-228 | `iia_benchmark.models.multivariate_book.CondenserPhysicalModel`<br>`iia_benchmark.models.multivariate_book.CondenserNOZAlarm` | `partial` |
