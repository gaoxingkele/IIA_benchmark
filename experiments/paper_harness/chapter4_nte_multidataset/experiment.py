#!/usr/bin/env python3
"""Execute one registered Chapter-4.1 NTE/NDTE multi-dataset run."""
...
RUN_PLAN = {
    "run_1": "configs/experiments/fcc_alarm_nte_ndte_structural_validation.json",
    "run_2": "configs/experiments/tep_alarm_nte_ndte_structural_validation.json",
    "run_3": "configs/experiments/npp_alarm_nte_ndte_structural_validation.json",
}
