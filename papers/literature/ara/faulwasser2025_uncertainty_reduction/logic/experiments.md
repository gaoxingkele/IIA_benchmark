...
- Boundary: 30 trees and at most 40 jackknife rows are a bounded independent validation. The official v3 capsule and exact synthetic/TEP payloads are now acquired; Tables 1-4 remain open, and the author code's overlapping CP-calibration/RF-training indices require a disclosed protocol-corrected ablation.
