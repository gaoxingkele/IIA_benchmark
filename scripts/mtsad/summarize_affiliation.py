...
def main() -> int:
    ...
    runs = {
        ...
        "catch": {
            "MSL": "affiliation_catch_msl.json",
            "PSM": "affiliation_catch_psm.json",
            "SMD": "affiliation_catch_smd.json",
            "SMAP": "affiliation_catch_smap.json",
            "SWaT": "affiliation_catch_swat.json",
        },
    }
